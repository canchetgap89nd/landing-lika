...
<!-- 		<div style="position: relative;" class ="col-xs-12 col-md-12">
   ...
   <?php include("form_gv.php"); ?>
  	...
  	<div id = "row1" class="col-xs-12 col-md-12">
		...
		<div id = "row2" class="col-xs-12 col-md-12">
		...
		<div style="margin-top: 40px;">
			...
			<div id = "row2-right" class="col-xs-12 col-md-6">
		  ...
		  <div class="tab-content">
		    <div role="tabpanel" class="tab-pane active" id="home">
		      	<div class="col-xs-12 col-md-5" style="text-align: center; margin-bottom: 20px;">
		      		<img style="width: auto;height: auto;" src = '‪../../IMG2/layer-69.png'>
		      	</div>
