				...
				<div  class="col-xs-12 col-md-12">
					 <div style="text-align: center;" class="col-xs-12 col-md-6"><img src = "IMG2\img1_lika_learning.png"></div>
  					 <div class="col-xs-12 col-md-6">
  					 	<p style = "font-size: 27px; text-align: left;font-family: roboto; padding: 0px 55px;">HIỆU QUẢ VỚI CON</p>
			
						<div id = "1c" class="col-xs-1 col-md-1">1</div><div id ="hq1" class="col-xs-11 col-md-11" style = "margin-bottom: 20px;"><b>Tự giác học mà không cần cha mẹ phải nhắc chỉ sau 1 tuần</b><br />Với giao diện bắt mắt, cộng đồng học sinh sôi nổi, nội dung bài tập hấp dẫn, đặc biệt thành tích học tập của các con luôn được ghi nhận bằng những quà tặng ý nghĩa, nên > 80% học sinh LIKA đã tự giác học tập không cần cha mẹ phải nhắc nhở chỉ sau 1 tuần học.</div>
						<div id = "2c" class="col-xs-1 col-md-1">2</div><div id ="hq2" class="col-xs-11 col-md-11" style = "margin-bottom: 20px;"><b>Tự tin, nổi bật so với các bạn trên lớp nhờ kỹ năng tính toán nhanh, chính xác</b><br />Chương trình học LIKA  được các giáo viên giỏi xây dựng từ cơ bản đến nâng cao, phù hợp với trình độ của trẻ, khi làm sai con được xem lại bài giảng của giáo viên giúp con củng cố và nâng cao kiến thức, từ đó tự tin, nổi bật so với các bạn mỗi khi đến lớp.</div>
						<div id = "3c" class="col-xs-1 col-md-1">3</div><div id ="hq3" class="col-xs-11 col-md-11" style = "margin-bottom: 20px;"><b>Mở rộng tri thức ở nhiều môn học</b><br />Phần giải thích sau mỗi câu hỏi, bài tập, đặc biệt những lĩnh vực liên quan đến khoa học tự nhiên, xã hội được thầy/cô giáo LIKA biên tập và chọn lọc kĩ lưỡng, vừa đảm bảo đúng, đủ kiến thức, vừa mở rộng thêm hiểu biết cho con.</div>						
  					 </div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-xs-12 col-md-12">
  					 <div class="col-xs-12 col-md-6">
						...
						<div class="col-xs-10 col-md-11" style = "margin-bottom: 20px; text-align: right;"><b>Tự giác học mà không cần cha mẹ phải nhắc chỉ sau 1 tuần</b><br />Với giao diện bắt mắt, cộng đồng học sinh sôi nổi, nội dung bài tập hấp dẫn, đặc biệt thành tích học tập của các con luôn được ghi nhận bằng những quà tặng ý nghĩa, nên > 80% học sinh LIKA đã tự giác học tập không cần cha mẹ phải nhắc nhở chỉ sau 1 tuần học.</div><div class="col-xs-2 col-md-1">1</div>
						<div class="col-xs-10 col-md-11" style = "margin-bottom: 20px; text-align: right;"><b>Tự tin, nổi bật so với các bạn trên lớp nhờ kỹ năng tính toán nhanh, chính xác</b><br />Chương trình học LIKA  được các giáo viên giỏi xây dựng từ cơ bản đến nâng cao, phù hợp với trình độ của trẻ, khi làm sai con được xem lại bài giảng của giáo viên giúp con củng cố và nâng cao kiến thức, từ đó tự tin, nổi bật so với các bạn mỗi khi đến lớp.</div><div class="col-xs-2 col-md-1">2</div>
						<div class="col-xs-10 col-md-11" style = "margin-bottom: 20px; text-align: right;"><b>Mở rộng tri thức ở nhiều môn học</b><br />Phần giải thích sau mỗi câu hỏi, bài tập, đặc biệt những lĩnh vực liên quan đến khoa học tự nhiên, xã hội được thầy/cô giáo LIKA biên tập và chọn lọc kĩ lưỡng, vừa đảm bảo đúng, đủ kiến thức, vừa mở rộng thêm hiểu biết cho con.</div><div class="col-xs-2 col-md-1">3</div>			 	 </div>
			     	 <div style="text-align: center;" class="col-xs-12 col-md-6" style="text-align: right;"><img src = "IMG2\img2_lika_learning.png"></div>
		  ...
		  <ul class="nav nav-tabs" role="tablist">
		    <li role="presentation" class="active">
		      <a href="#home" aria-controls="home" role="tab" data-toggle="tab">
		      	<p style = "font-size: 14px;color: #333;"><strong>Mẹ bé Đỗ Trọng Hoàng Minh</strong></p>
		      	<p style = "font-size: 14px;color: #333;color: #333;">Lớp 3 - Tiểu Học Dịch Vọng B Hà Nội</p>

		      </a>
		    </li>
		    <li role="presentation">
		      <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">
				<p style = "font-size: 14px;color: #333;"><strong> Mẹ bé Trịnh Xuân Đăng</strong></p>
		      	<p style = "font-size: 14px;color: #333;">Lớp 1 - Tiểu Học Thị Trấn Yên Viên</p>
		      </a>
		    </li>
		    <li role="presentation">
		      <a style="border: none;" href="#messages" aria-controls="messages" role="tab" data-toggle="tab">
		      	<p style = "font-size: 14px;color: #333;"><strong>Mẹ bé Phạm Minh Dũng</strong></p>
		      	<p style = "font-size: 14px;color: #333;">Lớp 2 - Tiểu Học Lê Văn Tám Hà Nội</p>
		      </a>
		    </li>
		  </ul>
		  <!-- Tab panes -->
